						...
						<div class="page-header">
							...
							<div class="ml-auto">
								<div class="input-group">
									...
									<a href="<?php echo site_url('Users/view_faq')?>"  class="btn btn-secondary text-white btn-sm" data-toggle="tooltip" title="" data-placement="bottom" data-original-title="View All Loan">
										<span>
											View All FAQ
										</span>
									</a>
							...
							<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
								...
								<div class="card">
									...
									<div class="card-body">
										 ...
										 <?php echo form_open('Users/add_faq_redirect',array("method"=>"POST")); ?>
											...
											<div class="form-group">
												...
												<div class="row">
														...
														<div class="col-lg-12 col-md-12">
															...
															<input type="text" name="faq_title"  class="form-control" placeholder="Enter FAQ Title" value="<?php echo set_value('faq_title'); ?>">																							
															<font color="red"><?=form_error("faq_title");?></font>
														...
														<div class="form-group">
															...
															<textarea id="elm1" name="faq_description" placeholder="Enter FAQ Description"><?php echo set_value('faq_description'); ?></textarea>

																	<font color="red"><?=form_error("faq_description");?></font>																				
																</div>
															</div>
														</div>	
