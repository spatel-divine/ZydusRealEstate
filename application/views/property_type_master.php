					...
					<div class="side-app">
						...
						<div class="row">
							...
							<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
								...
								<?php if($this->session->flashdata('property_type')) :?>

								<div class="alert alert-success alert-dismissable">
                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('property_type'); ?>
                                </div>
    						...
    						<?php endif;?> 
								...
								<div class="card">
									...
									<div class="card-header pb-0">
										...
										<h3 class="card-title">Add Property Type Details</h3>
									...
									<div class="card-body">
										...
										<?php echo form_open('Property/property_type_master_insert',array("method"=>"POST")); ?>
						...
						<div class="row">
							...
							<div class="col-md-12 col-lg-12">
								...
								<?php if($this->session->flashdata('update_property_type')) :?>

								<div class="alert alert-success alert-dismissable">
                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('update_property_type'); ?>
                                </div>
										...
										<table id="example" class="table table-striped table-bordered text-nowrap w-100">
											...
											<tbody>
												...
												<tr>
													...
													<td><a class="btn btn-primary" href="<?php echo base_url('Property/update_property_type/'.base64_encode($type['property_type_id']));?>"><i class="fa fa-edit"></i>Edit</a></td>
