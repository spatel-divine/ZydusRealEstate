					...
					<div class="side-app">
						...
						<div class="page-header">
							...
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item active" aria-current="page">Add Case Status</li>
						...
						<div class="row">
							...
							<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
								...
								<?php if($this->session->flashdata('case_status')) :?>

								<div class="alert alert-success alert-dismissable">
                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('case_status'); ?>
                                </div>
    						...
    						<?php endif;?>
								...
								<div class="card">
									...
									<div class="card-header pb-0">
										...
										<h3 class="card-title">Add Case Status Details</h3>
									...
									<div class="card-body">
										...
										<?php echo form_open('Legal/case_status_master_insert',array("method"=>"POST")); ?>
						...
						<div class="row">
							...
							<div class="col-md-12 col-lg-12">
								...
								<?php if($this->session->flashdata('update_case_status')) :?>

								<div class="alert alert-success alert-dismissable">
                                     <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('update_case_status'); ?>
                                </div>
							...
							<div class="card">
								...
								<div class="card-header pb-0">
									...
									<div class="card-title">Case Status List</div>
										...
										<table id="example" class="table table-striped table-bordered text-wrap w-100">
											...
											<tbody>
												...
												<tr>
													...
													<td><?= $status['case_status'];?></td>


													<td><a class="btn btn-primary" href="<?php echo base_url('Legal/update_case_status/'.base64_encode($status['case_status_id']));?>"><i class="fa fa-edit"></i>Edit</a></td>
