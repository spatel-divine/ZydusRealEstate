					...
					<div class="side-app">
						...
						<div class="page-header">
							...
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item active" aria-current="page">Add Property Status</li>
						...
						<div class="row">
							...
							<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
								...
								<?php if($this->session->flashdata('property_status')) :?>
								...
								<div class="card">
									...
									<div class="card-header pb-0">
										...
										<h3 class="card-title">Add Property Status Details</h3>
									...
									<div class="card-body">
										...
										<?php echo form_open('Property/property_status_master_insert',array("method"=>"POST")); ?>
											...
											<div class="form-group">
												...
												<div class="row">
													...
													<div class="col-lg-12 col-md-12">
														...
														<input type="text" class="form-control" name="status" id="status" placeholder="Enter Status"value="<?php echo set_value('status');?>">
						...
						<div class="row">
							...
							<div class="col-md-12 col-lg-12">
								...
								<?php if($this->session->flashdata('update_property_status')) :?>

								<div class="alert alert-success alert-dismissable">
                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('update_property_status'); ?>
                                </div>
                                <?php endif;?> 
							...
							<div class="card">
								...
								<div class="card-header pb-0">
									...
									<div class="card-title">Property Status List</div>
										...
										<table id="example" class="table table-striped table-bordered text-nowrap w-100">
											...
											<tbody>
												...
												<tr>
													...
													<td><a class="btn btn-primary" href="<?php echo base_url('Property/update_property_status/'.base64_encode($status['property_status_id']));?>"><i class="fa fa-edit"></i>Edit</a></td>
