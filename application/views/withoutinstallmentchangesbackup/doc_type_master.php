					...
					<div class="side-app">
						...
						<div class="page-header">
							...
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item active" aria-current="page">Add Document Type</li>
						...
						<div class="row">
							...
							<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
								...
								<?php if($this->session->flashdata('document_type')) :?>

								<div class="alert alert-success alert-dismissable">
                                   <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('document_type'); ?>
                                </div>
    						...
    						<?php endif;?> 
								...
								<div class="card">
									...
									<div class="card-header pb-0">
										...
										<h3 class="card-title">Add Document Type Details</h3>
									...
									<div class="card-body">
										...
										<?php echo form_open('Document/document_type_master_insert',array("method"=>"POST")); ?>
											...
											<div class="form-group">
												...
												<div class="row">
													...
													<div class="col-lg-12 col-md-12">
														...
														<input type="text" class="form-control" name="doc_type" id="doc_type" placeholder="Enter Document Type" value="<?php echo set_value('doc_type');?>">
						...
						<div class="row">
							...
							<div class="col-md-12 col-lg-12">
								...
								<?php if($this->session->flashdata('update_document_type')) :?>

								<div class="alert alert-success alert-dismissable">
                                   <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('update_document_type'); ?>
                                </div>
										...
										<table id="example" class="table table-striped table-bordered text-nowrap w-100">
											...
											<tbody>
												...
												<tr>
													...
													<td><a class="btn btn-primary" href="<?php echo base_url('Document/update_document_type/'.base64_encode($type['document_type_id']));?>"><i class="fa fa-edit"></i>Edit</a></td>
