					...
					<div class="side-app">
						...
						<div class="page-header">
							...
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item active" aria-current="page">Add Case By Details</li>
						...
						<div class="row">
							...
							<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
								...
								<?php if($this->session->flashdata('case_by')) :?>

								<div class="alert alert-success alert-dismissable">
                                     <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('case_by'); ?>
                                </div>
    						...
    						<?php endif;?> 
								...
								<div class="card">
									...
									<div class="card-header pb-0">
										...
										<h3 class="card-title">Add Case By Details</h3>
									...
									<div class="card-body">
										...
										<?php echo form_open('Legal/case_by_master_insert',array("method"=>"POST")); ?>
						...
						<div class="row">
							...
							<div class="col-md-12 col-lg-12">
								...
								<?php if($this->session->flashdata('update_case_by')) :?>

								<div class="alert alert-success alert-dismissable">
                                     <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('update_case_by'); ?>
                                </div>
							...
							<div class="card">
								...
								<div class="card-header pb-0">
									...
									<div class="card-title">Case By List</div>
                                	...
                                	<div class="table-responsive">
										...
										<table id="example" class="table table-striped table-bordered text-nowrap w-100">
											...
											<tbody>
												...
												<?php  if(!empty($case_by))
					                              {
					                              	$count = 1;

					                              	 foreach ($case_by as $case){?>
												...
												<tr>
													...
													<td><?= $case['case_by_contact_person'];?></td>



													<td><?= $case['case_by_email'];?></td>



													<td><?= $case['case_by_contact_no'];?></td>



													<td><?= $case['case_by_company_name'];?></td>



													<td><a class="btn btn-primary" href="<?php echo base_url('Legal/update_case_by/'.base64_encode($case['case_by_id']));?>"><i class="fa fa-edit"></i>Edit</a></td>
