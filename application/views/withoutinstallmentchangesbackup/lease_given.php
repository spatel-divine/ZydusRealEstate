	...
	<body class="app sidebar-mini">
					...
					<div class="side-app">
						...
						<div class="page-header">
							...
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item active" aria-current="page">Add Rent Receivable</li>
						...
						<?php if($this->session->flashdata('add_lease_given')) :?>

								<div class="alert alert-success alert-dismissable">
                                     <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('add_lease_given'); ?>
                                </div>
      							
    						<?php endif;?> 

    						<?php if($this->session->flashdata('check_lease_given_inserted')) :?>

								<div class="alert alert-danger alert-dismissable" style="background-color: #ec2d38;

    						border-color: #ec2d38;color:white;">
                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('check_lease_given_inserted'); ?>
                                </div>
							...
							<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
								...
								<div class="card">
									...
									<div class="card-header pb-0">
										...
										<h3 class="card-title">Add Rent Receivable Details</h3>
									...
									<div class="card-body">
										...
										<?php echo form_open_multipart('Lease/lease_given_redirect',array("method"=>"POST")); ?>
											...
											<div class="form-group">
												...
												<div class="row">
													...
													<div class="col-lg-6 col-md-12">
														...
														<select id="lessee_name[]" name="lessee_name[]" class="form-control" multiple>

															<?php foreach($lesse as $b):?>
																<option value="<?php echo $b['user_id'];?>" <?php echo  set_select('lessee_name[]', $b['user_id']); ?>><?php echo $b['username'];?></option>
	    													<?php endforeach; ?>

														</select>
														<span style="color:red;">Note : Hold down the Ctrl (windows) or Command (Mac) button to select multiple options.</span>

														<font color="red"><?=form_error("lessee_name[]");?></font>
														...
														<label>Lease Tenure Start Date</label>
																		...
																		<div class="wd-200 mg-b-30">
																			...
																			<div class="input-group">
																				...
																				</div><input class="form-control" id="datepicker0" autocomplete="off" placeholder="Start Date" type="text" name="start_date" value="<?php echo set_value('start_date');?>">
												...
												<div class="row">
													...
													<div class="col-lg-3 col-md-12">
															...
															<label>Total Area Available For Lease</label>
																		...
																		<input type="text" id="lease_area" name="lease_area" class="form-control" placeholder="Total Area Available For Lease" value="<?php echo set_value('lease_area');?>" readonly>
														...
														<div class="col-lg-2 col-md-12">
															...
															<label>Area Given on Lease</label>
																		...
																		<input type="text" id="given_area" name="area_given_on_lease" class="form-control" placeholder="Area Given on Lease" value="<?php echo set_value('area_given_on_lease');?>">

																		<font color="red"><?=form_error("area_given_on_lease");?></font>			
														...
														<div class="col-lg-2 col-md-12">
															...
															<input type="text" id="lease_security_deposit" name="lease_security_deposit" class="form-control" placeholder="Security Deposit" value="<?php echo set_value('lease_security_deposit');?>">
												...
												<div class="row">
													...
													<div class="col-lg-12 col-md-12">
															...
															<font color="red"><?php $new_in = $this->session->flashdata('new_in');
 															if($new_in==2) { echo "Upload Contract in Zip/JPEG/JPG/PNG/PDF/RAR Format Only.<br/>Rent Receivable Document size should not be exceed more than 20mb"; } ?></font>
        ...
        <script type="text/javascript">
            ...
            $('#property_name').change(function(){
                var id=$(this).val();
                 $.ajax({
                    url : "<?php echo site_url('Lease/get_lease_given_area');?>",
                    method : "POST",
                    data : {id: id},
                    async : true,
                    dataType : 'json',
                    success: function(data){
                        ...
                        for(i=0; i<data.length; i++){
                           $('#lease_area').val(data[i].rent_receivable_available_unit);
            ...
            $('#given_area').change(function(){

                var lease_area = parseFloat(document.getElementById("lease_area").value);
    			var given_area = parseFloat(document.getElementById("given_area").value);

		    	 if (given_area > lease_area) {
			    
		    		alert("Area Given on Lease Should not be Grater than Total Available Area For Lease");
			      document.getElementById("given_area").value = "";
		    	} else{
		    		document.getElementById("given_area").value = given_area.toFixed(2);
		    	}
