					...
					<div class="side-app">
						...
						<div class="page-header">
							...
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item active" aria-current="page">View Rent Payable Installment Details</li>
						...
						<div class="row">
							...
							<div class="col-md-12 col-lg-12">
								...
								<?php if($this->session->flashdata('lease_own_installment')) :?>

								<div class="alert alert-success alert-dismissable">
                                     <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('lease_own_installment'); ?>
                                </div>
							...
							<div class="card">
								...
								<div class="card-header pb-0">
									...
									<div class="card-title">Rent Payable Installments Lists</div>
								...
								<div class="card-body">
									...
									<?php echo form_open('Lease/rent_payable_installment_filter/',array("method"=>"POST")); ?>		
										<div class="form-group">
											...
											<div class="col-lg-2 col-md-12">
														...
														<a class="btn btn-primary" href="<?php echo base_url('Lease/lease_own_installment/');?>" style="margin-top:24px;width:80px;">Reset</a>
												</div>
											...
											<tbody>
												...
												<tr>
													...
													<td>
														...
														<?php 
															if($own['lease_payment_status'] == 'Not Paid' AND $current_date <= $own['end_date']) { ?>
														...
														<?php } else if($own['lease_payment_status'] == 'Paid' AND $current_date <= $own['end_date']) { ?>
															...
															<a class="btn btn-success" href="#" style="width:100%;">Paid</a>
													...
													<td><a class="btn btn btn-info" href="<?php echo base_url('Lease/view_lease_own_installments_history/'.base64_encode($own["lease_own_id"]));?>"><i class="fa fa-history"></i>History</a></td>
						...
						<div class="modal-dialog" role="document">
							...
							<?php echo form_open('Lease/lease_own_installment_paid/'.base64_encode($own['lease_own_id']),array("method"=>"POST")); ?>
								<div class="modal-header">



									<h5 class="modal-title" id="example-Modal3">Mark Rent Payable As Paid </h5>
								...
								<div class="modal-body">
										...
										<div class="form-group">
											...
											<div class="row">				
												...
												<input type="hidden" name="lease_own_id" value="<?php echo $own['lease_own_id'];?>">
								...
								<div class="modal-footer">
									...
									<input type="submit" class="btn btn-primary" value="Mark Rent Payable As Paid" name="mark_as_renewed">
