					...
					<div class="side-app">
						...
						<div class="page-header">
							...
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item active" aria-current="page">View Insurnce Details</li>
						...
						<div class="row">
    						...
    						<?php if($this->session->flashdata('insurance_delete')) :?>

								<div class="alert alert-danger alert-dismissable" style="background-color: #ec2d38;

    						border-color: #ec2d38;color:white;">
                                     <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('insurance_delete'); ?>
                                </div>
      							
    						<?php endif;?> 

    						<?php if($this->session->flashdata('insurance_update')) :?>

								<div class="alert alert-success alert-dismissable">
                                     <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('insurance_update'); ?>
                                </div>
							...
							<div class="card">
								...
								<div class="card-header pb-0">
									...
									<div class="card-title">Insurnce Lists</div>
								...
								<div class="card-body">
									...
									<?php echo form_open('Insurance/view_insurance_list_filter/',array("method"=>"POST")); ?>	
										<div class="form-group">
											<div class="row">
														...
														<option value="">Choose Property</option>
															...
															<?php foreach($property as $prop):
																...
																<?php foreach($access as $acc){if($acc == $prop['property_id']) { ?>	
	    															<option value="<?php echo $prop['property_id'];?>" <?php if(isset($_POST['property_id'])){ if($_POST['property_id'] == $prop['property_id']){ echo 'Selected';}}?>><?php echo $prop['property_name'];?></option>
	    														<?php }} ?>	
	    													<?php endforeach; ?>
												...
												<div class="col-lg-4 col-md-12">
													<label>Filter Insurance Company</label>
														...
														<select id="insurance_company_id" name="insurance_company_id" class="form-control">
															...
															<?php foreach($insurance_company as $company):?>
	    														<option value="<?php echo $company['insurance_company_id'];?>" <?php if(isset($_POST['insurance_company_id'])){ if($_POST['insurance_company_id'] == $company['insurance_company_id']){ echo 'Selected';}}?>><?php echo $company['insurance_company'];?></option>
	    													<?php endforeach; ?>

														</select>	
												</div>
												<!--<div class="col-lg-2 col-md-12">
													<label>Filter Insurance Type</label>
														...
														<select id="insurance_type_id" name="insurance_type_id" class="form-control">
															...
															<option value="">Insurance Type</option>
																...
																<?php foreach($insurance_type as $type):?>
	    															<option value="<?php echo $type['insurance_type_id'];?>" <?php if(isset($_POST['insurance_type_id'])){ if($_POST['insurance_type_id'] == $type['insurance_type_id']){ echo 'Selected';}}?>><?php echo $type['insurance_type'];?></option>
	    														<?php endforeach; ?>
														</select>
												</div>-->
												<!--<div class="col-lg-2 col-md-12">

															<label>Filter Beneficaries</label>



																<select id="insurance_beneficiary" name="insurance_beneficiary" class="form-control">

																	<option value="">Beneficaries</option>

																	<?php foreach($insurance_beneficary as $ben):?>
	    																<option value="<?php echo $ben['user_id'];?>" <?php if(isset($_POST['insurance_beneficiary'])){ if($_POST['insurance_beneficiary'] == $ben['user_id']){ echo 'Selected';}}?>><?php echo $ben['username'];?></option>
	    															<?php endforeach; ?>
												...
												<div class="col-lg-2 col-md-12">
													<label>Filter Lean Mark</label>

													<select id="lean_mark" name="lean_mark" class="form-control">

															<option value="">Lean Mark</option>

															<option vlaue="Yes" <?php if(isset($_POST['lean_mark'])){ if($_POST['lean_mark'] == "Yes"){ echo 'Selected';}}?>>Yes</option>

															<option vlaue="No" <?php if(isset($_POST['lean_mark'])){ if ($_POST['lean_mark'] == "No"){ echo 'Selected';}}?>
															>No</option>
												...
												<div class="col-lg-2 col-md-12">
													...
													<input type="submit" class="btn btn-primary" value="Filter" id="btn-filter" name="filter" style="margin-top:24px;width:80px;">
														...
														<a class="btn btn-primary" href="<?php echo base_url('Insurance/view_insurance_list/');?>" style="margin-top:24px;width:80px;">Reset</a>	
										...
										<table id="example" class="table table-striped table-bordered text-wrap w-100">
											...
											<thead>
												...
												<tr>
													...
													<th class="wd-20p">Insurance Expiry Date</th>
											...
											<tbody>
												...
												<tr>
													...
													<td><a class="btn btn btn-info" href="<?php echo base_url('Insurance/view_insurance_detail/'.base64_encode($inc["insurance_id"]));?>"><i class="fe fe-plus mr-2"></i> View More</a></td>


													<td><a class="btn btn-danger" href="<?php echo base_url('Insurance/delete_insurance_detail/'.base64_encode($inc["insurance_id"]));?>" onclick="return confirm('Are You Sure You Want To Delete Insurance Detail? With Deleting insurance Details of Claim will be Deleted.');"><i class="fa fa-trash"></i> Delete</a></td>
