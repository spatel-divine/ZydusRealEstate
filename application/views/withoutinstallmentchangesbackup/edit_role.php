									...
									<div class="card-body">
										...
										<div class="form-group">
											<div class="row">				
												...
												<div class="col-lg-6 col-md-12">
													<label>Property Access <?php $access = explode(",",$r['property_access']);?></label>


													<select id="property_name[]" name="property_name[]" class="form-control" multiple>
															...
															<?php foreach($property as $prop):
																...
																?>
	    													<option value="<?php echo $prop['property_id'];?>" <?php foreach($common_access as $acc){ if($acc == $prop['property_id']){ echo 'Selected'; }}?>><?php echo $prop['property_name'];?></option>
	    													<?php endforeach; ?>
