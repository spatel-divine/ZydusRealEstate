																...
																<div class="form-group">
																	...
																	<div class="row">
																		...
																		<div class="col-lg-2 col-md-12">
																			...
																			<?php } else { ?>
																				<input type="text" class="form-control" id="city" name="city" readonly value="<?php echo $p['city'];?>">
																			<?php } ?>
																		...
																		<div class="col-lg-2 col-md-12">
																			...
																			<?php } else { ?>
																				<input type="text" class="form-control" id="state" name="state" readonly value="<?php echo $p['state'];?>">
																			<?php } ?>
																		...
																		<div class="col-lg-2 col-md-12">
																			...
																			<?php } else { ?>
																				<input type="text" class="form-control" id="pincode" name="pincode"value="<?php echo $p['pincode'];?>">
																			<?php } ?>
												...
												<div id="leasse_seller">
														...
														<?php if($p['property_contract'] == 'Lease') {?>
															<div id="leasse">
																	...
																	<h5 class="mb-0" data-acc-title>Lessee Details</h5>
