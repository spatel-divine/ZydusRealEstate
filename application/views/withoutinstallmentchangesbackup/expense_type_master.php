					...
					<div class="side-app">
						...
						<div class="page-header">
							...
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item active" aria-current="page">Add Expense Type</li>
						...
						<div class="row">
							...
							<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
								...
								<?php if($this->session->flashdata('expense_type')) :?>

								<div class="alert alert-success alert-dismissable">
                                     <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('expense_type'); ?>
                                </div>
    						...
    						<?php endif;?> 
								...
								<div class="card">
									...
									<div class="card-body">
										...
										<?php echo form_open('Expense/expense_type_master_insert',array("method"=>"POST")); ?>
						...
						<div class="row">
							...
							<div class="col-md-12 col-lg-12">
									...
									<?php if($this->session->flashdata('update_expense_type')) :?>

								<div class="alert alert-success alert-dismissable">
                                     <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('update_expense_type'); ?>
                                </div>
							...
							<div class="card">
								...
								<div class="card-header pb-0">
									...
									<div class="card-title">Expense Type List</div>
										...
										<table id="example" class="table table-striped table-bordered text-nowrap w-100">
											...
											<tbody>
												...
												<tr>
													...
													<td><a class="btn btn-primary" href="<?php echo base_url('Expense/update_expense_type/'.base64_encode($type['expense_type_id']));?>"><i class="fa fa-edit"></i>Edit</a></td>
