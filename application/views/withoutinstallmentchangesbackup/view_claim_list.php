				...
				<div class="app-content  my-3 my-md-5">
					...
					<div class="side-app">
						...
						<div class="page-header">
							...
							<div class="ml-auto">
								...
								<div class="input-group">
									...
									<?php $r = explode(",",$roles); if(in_array("Claim Master",$r)) { ?>

									<a href="<?php echo base_url('Insurance/claim_master');?>" class="btn btn-secondary text-white btn-sm" data-toggle="tooltip" title="" data-placement="bottom" data-original-title="Add New">

										<span>

											<i class="fa fa-plus">Add Claim Details</i>
						...
						<div class="row">
    						...
    						<?php if($this->session->flashdata('delete_claim')) :?>

								<div class="alert alert-danger alert-dismissable" style="background-color: #ec2d38;

    						border-color: #ec2d38;color:white;">
                                     <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('delete_claim'); ?>
                                </div>
      							
    						<?php endif;?> 

    						<?php if($this->session->flashdata('update_claim')) :?>

								<div class="alert alert-success alert-dismissable">
                                     <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('update_claim'); ?>
                                </div>
							...
							<div class="card">
								...
								<div class="card-header pb-0">
									...
									<div class="card-title">Claim Lists</div>
								...
								<div class="card-body">
									...
									<?php echo form_open('Insurance/claim_filter/',array("method"=>"POST")); ?>
										...
										<div class="col-lg-5 col-md-12">
														<label>Filter By Surveyer Staus</label>
														<select name="surveyer_status" class="form-control">
															<option value="">Choose Surveyer Status</option>
															<option value="Not Assigned Status Yet" <?php echo (set_value('surveyer_status')== "Not Assigned Status Yet")?" selected=' selected'":""?>>Not Assigned Status Yet</option>
									...
									<div class="col-lg-2 col-md-12">
													...
													<input type="submit" class="btn btn-primary" value="Filter" id="btn-filter" name="filter" style="margin-top:24px;width:80px;">
														...
														<a class="btn btn-primary" href="<?php echo base_url('Insurance/view_claim_list/');?>" style="margin-top:24px;width:80px;">Reset</a>	
										...
										<table id="example" class="table table-striped table-bordered text-wrap w-100">
											...
											<thead>
												...
												<tr>
													...
													<th class="wd-20p">CLaim Date Launch</th>



													<th class="wd-20p">Claim Amount</th>

													<th class="wd-20p">Surveyer Status</th>
											...
											<tbody>
												...
												<tr>
													...
													<td><?= date("d-m-Y", strtotime($inc['claim_date_lunch']))?></td>
													<td><?= $inc['claim_amount'];?></td>

													<td><?= $inc['surveyer_status'];?></td>

													<td><a class="btn btn btn-info" href="<?php echo base_url('Insurance/view_claim_detail/'.base64_encode($inc["claim_id"]));?>"><i class="fe fe-plus mr-2"></i> View More</a></td>

													<td><a class="btn btn-primary" href="<?php echo base_url('Insurance/edit_claim_detail/'.base64_encode($inc["claim_id"]));?>"><i class="fa fa-edit"></i> Edit</a></td>


													<td><a class="btn btn-danger" href="<?php echo base_url('Insurance/delete_claim_detail/'.base64_encode($inc["claim_id"]));?>" onclick="return confirm('Are You Sure You Want To Delete Claim Detail?');"><i class="fa fa-trash"></i> Delete</a></td>
