					...
					<div class="side-app">
						...
						<div class="page-header">
							...
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item active" aria-current="page">View Loan Installments Details</li>
							...
							<div class="ml-auto">
								...
								<div class="input-group">
									...
									<?php $r = explode(",",$roles); if(in_array("View Loan Installments",$r)) { ?>

									<a href="<?php echo site_url('Loan/loan_installments/')?>" class="btn btn-secondary text-white btn-sm" data-toggle="tooltip" title="" data-placement="bottom" data-original-title="View">
						...
						<div class="row">
							...
							<div class="card">
								...
								<div class="card-header pb-0">
									...
									<div class="card-title">Loan Installments Lists</div>
										...
										<table id="example" class="table table-striped table-bordered text-wrap w-100">
											...
											<tbody>
												...
												<tr>
													...
													<td><?= $ln['payment_reference'];?></td>

													<td><?= date("d-m-Y", strtotime($ln['loan_installment_added_date']));?></td>
