					...
					<div class="side-app">
						...
						<div class="page-header">
							...
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item active" aria-current="page">View Income</li>
							...
							<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
								...
								<div class="card">
									...
									<div class="card-header pb-0">
										...
										<h3 class="card-title">View Income Details</h3>
										 ...
										 <?php  if(!empty($income))
                              			{
												...
												<div class="row">
													...
													<div class="col-lg-6 col-md-12">
															...
															<label>Ledger Head</label>
																		...
																		<input type="text" id="ledger_head" name="ledger_head" class="form-control" placeholder="Enter Ledger Head" value="<?php echo $inc['income_ledger_head']; ?>" readonly>
													...
													<div class="col-lg-6 col-md-12">
															...
															<label>Ledger Number</label>
																		...
																		<input type="text" id="ledger_number" name="ledger_number" class="form-control" placeholder="Enter Ledger Number" value="<?php echo $inc['income_ledger_number']; ?>" readonly>
											...
											<div class="form-group">
												...
												<div class="row">
													...
													<div class="col-lg-3 col-md-12">
														...
														<input type="text" id="income_title" name="income_title" class="form-control" placeholder="Enter Income Title" value="<?php echo $inc['income_title']; ?>" readonly>
													...
													<div class="col-lg-3 col-md-12">
														...
														<input type="text" id="income_amount" name="income_amount" class="form-control" placeholder="Enter Income Amount" value="<?php echo $inc['income_amount']; ?>" readonly>		
													...
													<div class="col-lg-3 col-md-12">
														...
														<div class="wd-200 mg-b-30">
																			...
																			<div class="input-group">
																				...
																				</div><input class="form-control"  name="income_date" autocomplete="off" placeholder="Enter Income Date" type="text" value="<?php echo date("d-m-Y", strtotime($inc['income_date'])); ?>" readonly>
											...
											<div class="form-group">
												...
												<div class="row">
													...
													<div class="col-lg-4 col-md-12">
														...
														<input type="text" class="form-control" value="<?php echo $inc['income_type'];?>" readonly>
														...
														<div class="col-lg-4 col-md-12">
															...
															<label>Invoice Number</label>
																		...
																		<input type="text" id="invoice_number" name="invoice_number" class="form-control" placeholder="Enter Invoice Number" value="<?php echo $inc['income_invoice_number']; ?>" readonly>
														...
														<div class="col-lg-3 col-md-12">
															...
															<div class="col-lg-3 col-md-12">
																...
																<label class="custom-control custom-radio">
																	...
																	<input type="radio" class="custom-control-input" name="recurring_income" value="Yes" <?php if($inc['recurring_income'] == 'Yes') { echo "Checked"; }?> disabled>
																...
																<label class="custom-control custom-radio">
																	...
																	<input type="radio" class="custom-control-input" name="recurring_income" value="No" <?php if($inc['recurring_income'] == 'No') { echo "Checked"; }?> disabled>
												...
												<div class="row">
													...
													<div class="col-lg-12 col-md-12">
															...
															if((in_array('.zip',$ext)) OR (in_array('.rar',$ext))){ ?>
																	<br/>
																<h5><b>View of This Document is Not Available Please Download the Document.</b> <a href="<?php echo base_url('Income/download_income_invoice/'.base64_encode($inc['income_id']));?>"></h5> 
															<?php } else { ?>

																<a href="<?php echo base_url('Income/download_income_invoice/'.base64_encode($inc['income_id']));?>"><embed src="<?php echo base_url('assets/images/uploads/invoice_upload/income/'.(base64_decode($inc['invoice_upload'])));?>" width="100%" height="500px"></a>		
															<?php } ?>	
											...
											<div class="form-group"  style="float:right;">
												...
												<div class="row">
													...
													<a href="<?php echo base_url('Income/download_income_invoice/'.base64_encode($inc['income_id']));?>" class="btn btn-primary">Income Invoice Download</a>
