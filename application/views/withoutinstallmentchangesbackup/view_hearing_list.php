					...
					<div class="side-app">
						...
						<div class="page-header">
							...
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item active" aria-current="page">View Case Hearing Details</li>
							...
							<div class="ml-auto">
								...
								<div class="input-group">
									...
									<?php $r = explode(",",$roles); if(in_array("Hearing Master",$r)) { ?>

									<a href="<?php echo site_url('Legal/hearing_master/')?>" class="btn btn-secondary text-white btn-sm" data-toggle="tooltip" title="" data-placement="bottom" data-original-title="Add New">

										<span>

											<i class="fa fa-plus">Add Case Hearing Details</i>
						...
						<div class="row">
    						...
    						<?php if($this->session->flashdata('update_hearing')) :?>

								<div class="alert alert-success alert-dismissable">
                                   <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('update_hearing'); ?>
                                </div>
      							
    						<?php endif;?> 

    						<?php if($this->session->flashdata('delete_hearing')) :?>

								<div class="alert alert-success alert-dismissable" style="background-color: #ec2d38;border-color: #ec2d38;color:white;">
                                   <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('delete_hearing'); ?>
                                </div>
							...
							<div class="card">
								...
								<div class="card-header pb-0">
									...
									<div class="card-title">Case Hearing Lists</div>
								...
								<div class="card-body">
									...
									<?php echo form_open('Legal/hearing_filter/',array("method"=>"POST")); ?>
										...
										<div class="row">
											...
											<div class="col-lg-2 col-md-12">
												...
												<input type="submit" class="btn btn-primary" value="Filter" id="btn-filter" name="filter" style="margin-top:24px;width:80px;">
														...
														<a class="btn btn-primary" href="<?php echo base_url('Legal/view_hearing_list/');?>" style="margin-top:24px;width:80px;">Reset</a>	
										...
										<table id="example" class="table table-striped table-bordered text-wrap w-100">
											...
											<thead>
												...
												<tr>
													...
													<th class="wd-15p">Hearing Date</th>



													<th class="wd-15p">Next Hearing Date</th>



													<th class="wd-20p">Case Status</th>
											...
											<tbody>
												 ...
												 <?php  if(!empty($hearing_list))
                             					 {
                              						$count = 1;

                              	 					foreach ($hearing_list as $hearing){
												...
												<tr>
												   ...
												   <td><?= $count;?></td>
													...
													<td><?= $hearing['property_name'];?></td>


													<td><?= $hearing['case_number'];?></td>

													<td><?= date("d-m-Y", strtotime($hearing['hearing_date']));?></td>



													<td><?= date("d-m-Y", strtotime($hearing['next_hearing_date']));?></td>
													...
													<td><a class="btn btn-info" href="<?php echo base_url('Legal/view_hearing_data/'.base64_encode($hearing["hearing_id"]));?>"><i class="fe fe-plus mr-2"></i> View More</a></td>


													<?php if($hearing['case_status'] !== 'Completed'){ ?>
														<td><a class="btn btn-primary" style="width:100%" href="<?php echo base_url('Legal/edit_hearing_details/'.base64_encode($hearing["hearing_id"]));?>"><i class="fa fa-edit"></i> Edit</a></td>
													<?php } else { ?>
															<td><a class="btn btn-danger" style="color:white;">Edit N/A</a></td>
													<?php } ?>	

														<td><a class="btn btn-danger" href="<?php echo base_url('Legal/delete_hearing_detail/'.base64_encode($hearing["hearing_id"]));?>" onclick="return confirm('Are You Sure You Want To Delete Hearing Detail?');"><i class="fa fa-trash"></i> Delete</a></td>
