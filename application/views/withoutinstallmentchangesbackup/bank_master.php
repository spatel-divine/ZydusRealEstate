					...
					<div class="side-app">
						...
						<div class="row">
							...
							<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
								...
								<?php if($this->session->flashdata('insert_bank')) :?>

								<div class="alert alert-success alert-dismissable">
                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('insert_bank'); ?>
                                </div>
    						...
    						<?php endif;?> 
								...
								<div class="card">
									...
									<div class="card-body">
										...
										<?php echo form_open('Loan/bank_master_insert',array("method"=>"POST")); ?>
											...
											<div class="form-group">
												...
												<div class="row">
													...
													<div class="col-lg-3 col-md-12">
														...
														<textarea class="form-control" name="bank_address" id="bank_address" placeholder="Enter Bank Address"><?php echo set_value('bank_address');?></textarea>
						...
						<div class="row">
							...
							<div class="col-md-12 col-lg-12">
									...
									<?php if($this->session->flashdata('update_bank')) :?>

								<div class="alert alert-success alert-dismissable">
                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('update_bank'); ?>
                                </div>
										...
										<table id="example" class="table table-striped table-bordered text-wrap w-100">
											...
											<thead>
												...
												<tr>
													...
													<th class="wd-15p">Bank Email</th>



													<th class="wd-15p">Bank Contact Number</th>
											...
											<tbody>
												...
												<tr>
													...
													<td><a class="btn btn-primary" href="<?php echo base_url('Loan/update_bank_details/'.base64_encode($bank['bank_id']));?>"><i class="fa fa-edit"></i>Edit</a></td>
