					...
					<div class="side-app">
						...
						<div class="page-header">
							...
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item active" aria-current="page">Add Document Authority</li>
						...
						<div class="row">
							...
							<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
								...
								<?php if($this->session->flashdata('document_authority')) :?>

								<div class="alert alert-success alert-dismissable">
                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('document_authority'); ?>
                                </div>
    						...
    						<?php endif;?>
								...
								<div class="card">
									...
									<div class="card-header pb-0">
										...
										<h3 class="card-title">Add Document Authority Details</h3>
									...
									<div class="card-body">
										...
										<?php echo form_open('Document/document_authority_insert',array("method"=>"POST")); ?>
						...
						<div class="row">
							...
							<div class="col-md-12 col-lg-12">
								...
								<?php if($this->session->flashdata('update_document_authority')) :?>

								<div class="alert alert-success alert-dismissable">
                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('update_document_authority'); ?>
                                </div>
							...
							<div class="card">
								...
								<div class="card-header pb-0">
									...
									<div class="card-title">Document Authority List</div>
										...
										<table id="example" class="table table-striped table-bordered text-wrap w-100">
											...
											<thead>
												...
												<tr>
													...
													<th class="wd-15p">Document Authority</th>
											...
											<tbody>
												...
												<?php  if(!empty($document_authority))
					                              {
					                              	$count = 1;

					                              	 foreach ($document_authority as $auth){?>
												...
												<tr>
													...
													<td><?= $auth['document_authority'];?></td>



													
													<td><a class="btn btn-primary" href="<?php echo base_url('Document/update_document_authority/'.base64_encode($auth['document_auth_id']));?>"><i class="fa fa-edit"></i>Edit</a></td>
