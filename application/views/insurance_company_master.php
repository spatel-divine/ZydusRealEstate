					...
					<div class="side-app">
						...
						<div class="row">
							...
							<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
								...
								<?php if($this->session->flashdata('insurance_company')) :?>

								<div class="alert alert-success alert-dismissable">
                                     <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('insurance_company'); ?>
                                </div>
    						...
    						<?php endif;?> 
								...
								<div class="card">
									...
									<div class="card-header pb-0">
										...
										<h3 class="card-title">Add Insurance Company Details</h3>
									...
									<div class="card-body">
										...
										<?php echo form_open('Insurance/insurance_company_master_insert',array("method"=>"POST")); ?>
											...
											<div class="form-group">
												...
												<div class="row">
													...
													<div class="col-lg-12 col-md-12">
														...
														<input type="text" class="form-control" name="insurance_company" id="insurance_company" placeholder="Enter Insurance Comapny" value="<?php echo set_value('insurance_company');?>">

														<font color="red"><?=form_error("insurance_company");?></font>
						...
						<div class="row">
    						...
    						<?php if($this->session->flashdata('update_insurance_company')) :?>

								<div class="alert alert-success alert-dismissable">
                                     <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('update_insurance_company'); ?>
                                </div>
							...
							<div class="card">
								...
								<div class="card-header pb-0">
									...
									<div class="card-title">Insurance Company List</div>
										...
										<table id="example" class="table table-striped table-bordered text-nowrap w-100">
											...
											<thead>
												...
												<tr>
													...
													<th class="wd-15p">Insurance Company</th>
											...
											<tbody>
													 ...
													 <?php  if(!empty($insurance_company))
                              				{
												...
												<tr>
													...
													<td><?= $company['insurance_company'];?></td>



													<!--<td><a class="btn btn-danger" href="<?php echo base_url('Insurance/delete_insurance_company/'.base64_encode($company['insurance_company_id']));?>" onclick="return confirm('Are You Sure You Want To Delete Insurance Company');"><i class="fa fa-trash"></i> Delete</a></td>-->

													<td><a class="btn btn-primary" href="<?php echo base_url('Insurance/update_insurance_company/'.base64_encode($company['insurance_company_id']));?>"><i class="fa fa-edit"></i> Edit</a></td>
