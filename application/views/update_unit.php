						...
						<div class="page-header">
							...
							<div class="ml-auto">
								<div class="input-group">
									<?php $r = explode(",",$roles); if(in_array("Unit Master",$r)) { ?>
									<a href="<?php echo site_url('Property/unit_master/')?>"  class="btn btn-secondary text-white btn-sm" data-toggle="tooltip" title="" data-placement="bottom" data-original-title="View All Unit">
										<span>
											View All Unit
										</span>
									</a>
							...
							<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
								...
								<div class="card">
									...
									<div class="card-body">
										...
										<?php echo form_open('Property/update_unit_redirect/'.base64_encode($u['unit_id']),array("method"=>"POST")); ?>
											...
											<div class="form-group">
												...
												<div class="row">
													...
													<div class="col-lg-12 col-md-12">
														...
														<?php if($this->input->post('submit') && $this->input->post('unit') !== $u['unit']) { ?>

															<input type="text" class="form-control" name="unit" id="unit" placeholder="Enter Unit" value="<?php echo set_value('unit');?>">
															
														<?php } else { ?>	

															<input type="text" class="form-control" name="unit" id="unit" placeholder="Enter Unit" value="<?php echo $u['unit'];?>">
														<?php } ?>	
