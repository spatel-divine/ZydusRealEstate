					...
					<div class="side-app">
						...
						<div class="page-header">
							...
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item active" aria-current="page">Edit Rent Payable</li>
							...
							<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
								...
								<div class="card">
									...
									<div class="card-header pb-0">
										...
										<h3 class="card-title">Edit Rent Payable Details</h3>
									...
									<div class="card-body">
										 ...
										 foreach($lease_own as $lease){
											  echo form_open_multipart('Lease/edit_lease_own_detail_redirect/'.base64_encode($lease['lease_own_id']),array("method"=>"POST"));
											...
											<div class="form-group">
												...
												<div class="row">
													...
													<div class="col-lg-5 col-md-12">
														...
														<?php $one = 0;  foreach($lessor1 as $leo){?>
															...
															<div class="form-group removethis3">
																<div class="row">
																	...
																	<select id="lessor_name[<?= $one ?>]" name="lessor_name[<?= $one ?>]" class="form-control">

																		<option value="">Choose Lessor</option>

																			<?php foreach($lessor as $b):?>
																				<option value="<?php echo $b['user_id'];?>" <?php if ($leo['lessor_id']== $b['user_id']) { echo 'Selected';}?>><?php echo $b['username'];?></option>
				    														<?php endforeach; ?>
														...
														<font color="red"><?=form_error("lessor_name[0]");?></font>
													...
													<div class="col-lg-2 col-md-12">
														...
														<input type="button" class="btn btn-primary" id="adddoc1" value="Add" onclick='show_lessor(this.value);' style="margin-top: 24px;"></button>

												        <input type="button" class="btn btn-primary" id="removedoc1" value="Remove" style="margin-top: 24px;"></button>			
												...
												<div class="row">
													...
													<div class="col-lg-2 col-md-12">
															...
															<label>Area Taken on Lease</label>
																	...
																	<?php if($this->input->post('submit') && $this->input->post('lease_area') !== $lease['area_taken_on_lease']) { ?>
																...
																<?php } else{?>
																		...
																		<input type="text" id="lease_area" name="lease_area" class="form-control" placeholder="Lease Area" value="<?php echo $lease['area_taken_on_lease'];?>">
																<?php }?>			
														...
														<div class="col-lg-4 col-md-12">
															...
															<select id="lease_contract_status" name="lease_contract_status" class="form-control">
																...
																<?php foreach($contract_status as $status):?>
																	...
																	<option value="<?php echo $status['lease_own_status_id'];?>" <?php if($lease['lease_contract_status']== $status['lease_own_status_id']){ echo 'Selected';}?>><?php echo $status['lease_own_status'];?></option>
											...
											<div class="form-group">
												...
												<div class="row">
													...
													<div class="col-lg-12 col-md-12">
															...
															<label>Lease Contract Upload &nbsp;&nbsp;<a href="<?php echo base_url('lease/download_lease_own_contract/'.base64_encode($lease['lease_own_id']));?>" class="btn btn-primary btn-sm">Download Current Rent Payable Contract</a></label>



																																	

															<input type="file" class="dropify" name="lease_contract_upload" id="lease_contract_upload" class="dropify">
...
$(document).ready(function() {
	 ...
	 $("#adddoc1").on("click", function() {
				 ...
				 if(x3 < max_fields){ 				
				$("#documentadd1").append('<div class="form-group"><div class="row"><div class="col-lg-5 col-md-12"></div><div class="col-lg-5 col-md-12"><div class="form-group"><div class="row"><label>Lessor Name</label><select id="lessor_name['+x3+']" name="lessor_name['+x3+']" class="form-control"><option value="">Choose Lessor</option><?php foreach($lessor as $b):?><option value="<?php echo $b['user_id'];?>"><?php echo $b['username'];?></option><?php endforeach; ?></select></div></div></div></div></div>');
				x3++;
				}
