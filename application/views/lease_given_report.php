					...
					<div class="side-app">
						...
						<div class="page-header">
							...
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item active" aria-current="page">View Rent Receivable History Details</li>
						...
						<div class="row">
    						...
    						<?php if($this->session->flashdata('update_lease_given')) :?>

								<div class="alert alert-success alert-dismissable">
                                     <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('update_lease_given'); ?>
                                </div>
      							
    						<?php endif;?> 

    						<?php if($this->session->flashdata('delete_lease_given')) :?>

								<div class="alert alert-danger alert-dismissable" style="background-color: #ec2d38;

    						border-color: #ec2d38;color:white;">
                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('delete_lease_given'); ?>
                                </div>
							...
							<div class="card">
								...
								<div class="card-header pb-0">
									...
									<div class="card-title">Rent Receivable Histroy</div>
								...
								<div class="card-body">
									...
									<?php echo form_open('Lease/filter_lease_given/',array("method"=>"POST","id"=>"form-filter")); ?>	
										...
										<div class="form-group">
											...
											<div class="row">
												...
												<div class="col-lg-2 col-md-12">
														...
														<a class="btn btn-primary" href="<?php echo base_url('Lease/lease_given_report/');?>" style="margin-top:24px;width:80px;">Reset</a>
													</div>
...
<thead>
												...
												<tr>
													...
													<!--<th class="wd-15p">Finacial Status</th>-->
											...
											<tbody>
												...
												<tr>
													...
													<td><?= $given['property_name'];?></td>



													<td><?= $given['lease_amount'];?></td>

													<td><?= date("d-m-Y", strtotime($given['start_date']));?></td>



													<td><?= date("d-m-Y", strtotime($given['end_date']));?></td>
													...
													<td width="120px">
														...
														foreach($lease_given_lessee as $lessee) {
															if($lessee['lease_given_id'] === $given['lease_given_id']){
																?>
                									...
                									<?php if($given['lease_increment_type'] == 'Percentage'){?>

                									<td><?= $given['lease_increment']."%";?></td>
                								<?php } else {?>
                										<td><?= "₹" .$given['lease_increment'];?></td>
                								<?php }?>	
                									<td><?= $given['lease_increment_month'];?></td>

                									<!--<td><?= $given['financial_status'];?></td>-->
												

													<td><a class="btn btn-danger" href="<?php echo base_url('Lease/delete_lease_given_detail/'.base64_encode($given["lease_given_id"]));?>" onclick="return confirm('Are You Sure You Want To Delete Rent Receivable Detail With Deleting this Rent Detail Installment Details for these Lease is also Deleted?');"><i class="fa fa-trash"></i> Delete</a></td>

													<td><a class="btn btn-info" href="<?php echo base_url('Lease/view_lease_given_data/'.base64_encode($given["lease_given_id"]));?>"><i class="fe fe-plus mr-2"></i> View</a></td>

													<td>
													<?php if ($given['mark_property_as_sold'] == "No") {?>	
														<?php $current_date = date('Y-m-d');

													if($given['end_date'] > $current_date ) {
