					...
					<div class="side-app">
						...
						<div class="page-header">
							...
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item active" aria-current="page">Add Poilce Station Details</li>
						...
						<div class="row">
							...
							<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
								...
								<?php if($this->session->flashdata('police_station')) :?>

								<div class="alert alert-success alert-dismissable">
                                     <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('police_station'); ?>
                                </div>
    						...
    						<?php endif;?>
								...
								<div class="card">
									...
									<div class="card-header pb-0">
										...
										<h3 class="card-title">Add Police Station Details</h3>
									...
									<div class="card-body">
										...
										<?php echo form_open('Legal/police_station_master_insert',array("method"=>"POST")); ?>
						...
						<div class="row">
							...
							<div class="col-md-12 col-lg-12">
								...
								<?php if($this->session->flashdata('update_police_station')) :?>

								<div class="alert alert-success alert-dismissable">
                                     <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('update_police_station'); ?>
                                </div>
							...
							<div class="card">
								...
								<div class="card-header pb-0">
									...
									<div class="card-title">Police Station List</div>
										...
										<table id="example" class="table table-striped table-bordered text-wrap w-100">
											...
											<thead>
												...
												<tr>
													...
													<th class="wd-15p">Police Station Name</th>
											...
											<tbody>
												...
												<?php  if(!empty($police_station))
					                              {
					                              	$count = 1;

					                              	 foreach ($police_station as $police){?>
												...
												<tr>
													...
													<td><?= $police['police_station_contact_number'];?></td>



													<td><?= $police['police_station_branch'];?></td>



													<td><?= $police['police_station_address'];?></td>

													<td><?= $police['police_station_state'];?></td>

													<td><?= $police['police_station_city'];?></td>

													<td><?= $police['police_station_pincode'];?></td>



													<td><a class="btn btn-primary" href="<?php echo base_url('Legal/update_police_station_detail/'.base64_encode($police['police_station_id']));?>"><i class="fa fa-edit"></i>Edit</a></td>
