					...
					<div class="side-app">
						...
						<div class="page-header">
							...
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item active" aria-current="page">View Expense Details</li>
							...
							<div class="ml-auto">
								...
								<div class="input-group">
									...
									<?php $r = explode(",",$roles); if(in_array("Recurring Expense List",$r)) { ?>

									<a href="<?php echo base_url('Expense/recurring_expense_list');?>" class="btn btn-secondary text-white btn-sm" data-toggle="tooltip" title="" data-placement="bottom" data-original-title="View All">

										<span>
											View Recurring Expense List
										</span>
									...
									<a href="<?php echo base_url('Expense/expense_master');?>" class="btn btn-secondary text-white btn-sm" data-toggle="tooltip" title="" data-placement="bottom" data-original-title="Add New">
										...
										<span>
											...
											<i class="fa fa-plus">Add Expense Details</i>
						...
						<div class="row">
    						...
    						<?php if($this->session->flashdata('delete_expense')) :?>

								<div class="alert alert-danger alert-dismissable" style="background-color: #ec2d38;

    						border-color: #ec2d38;color:white;">
                                     <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('delete_expense'); ?>
                                </div>
      							
    						<?php endif;?> 

    						<?php if($this->session->flashdata('update_expense')) :?>

								<div class="alert alert-success alert-dismissable">
                                     <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('update_expense'); ?>
                                </div>
							...
							<div class="card">
								...
								<div class="card-header pb-0">
									...
									<div class="card-title">Expense Lists</div>
								...
								<?php echo form_open('Expense/filter_expense/',array("method"=>"POST","id"=>"form-filter")); ?>	
									...
									<div class="form-group">
										...
										<div class="row">
											...
											<div class="col-lg-3 col-md-12">
												...
												<label>Filter By Expense Date</label>
											...
											<div class="col-lg-2 col-md-12">
													...
													<a class="btn btn-primary" href="<?php echo base_url('Expense/view_expense_list/');?>" style="margin-top:24px;width:80px;">Reset</a>
												</div>
