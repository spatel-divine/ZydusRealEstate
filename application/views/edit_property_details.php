    						...
    						<?php endif;?> 
								...
								<div class="card">
									...
									<div class="card-body">
										...
										<?php echo form_open_multipart('Property/edit_property_detail_redirect/'.base64_encode($p['property_id']), array('id' => 'form'));?>
												...
												<div class="list-group-item py-3" data-acc-step>
													...
													<div data-acc-content>
														...
														<div class="my-3">
																	...
																	<div class="form-group">
																		...
																		<div class="row">
																			...
																			<div class="col-lg-6 col-md-12">
																				...
																				<?php if($this->input->post('submit') && $this->input->post('property_type') !== $p['property_type_id']) { ?>
																				...
																				<?php } else { ?>
																					...
																					<option value="">Choose Property Type</option>
																					<?php foreach($property_type as $prop):?>
																						<option value="<?php echo $prop['property_type_id'];?>" <?php if($prop['property_type_id'] == $p['property_type_id']) {echo 'Selected';}?>><?php echo $prop['property_type'];?></option>
	    																			<?php endforeach; ?>
																				</select>
																			...
																			<div class="col-lg-6 col-md-12">
																				...
																				<?php if($this->input->post('submit') && $this->input->post('property_name') !== $p['property_name']) { ?>
																				...
																				<?php } else { ?>
																					<input type="text" class="form-control" id="property_name" name="property_name" placeholder="Enter Property Title" value="<?php echo $p['property_name'];?>">
																				<?php } ?>		
																...
																<div class="form-group">
																	...
																	<div class="row">
																		...
																		<div class="col-lg-6 col-md-12">
																			...
																			<?php if($this->input->post('submit') && $this->input->post('address') !== $p['property_address']) { ?>
																			...
																			<?php } else { ?>
																				...
																				<input type="text" autocomplete="off" class="form-control" id="my-address" onchange="codeAddress();"  name="address" placeholder="Enter Property Address" value="<?php echo $p['property_address'];?>">
																		...
																		<div class="col-lg-2 col-md-12">
																			...
																			<?php if($this->input->post('submit') && $this->input->post('city') !== $p['city']) { ?>
																				<input type="text" class="form-control" id="city" name="city" placeholder="City" value="<?php echo set_value('city');?>">
																			<?php } else { ?>
																				<input type="text" class="form-control" id="city" name="city" placeholder="City" value="<?php echo $p['city'];?>">
																			<?php } ?>
																		...
																		<div class="col-lg-2 col-md-12">
																			...
																			<?php if($this->input->post('submit') && $this->input->post('state') !== $p['state']) { ?>
																				<input type="text" class="form-control" id="state" name="state" placeholder="State" value="<?php echo set_value('state');?>">
																			<?php } else { ?>
																				<input type="text" class="form-control" id="state" name="state" placeholder="State" value="<?php echo $p['state'];?>">
																			<?php } ?>
																		...
																		<div class="col-lg-2 col-md-12">
																			...
																			<?php if($this->input->post('submit') && $this->input->post('pincode') !== $p['pincode']) { ?>
																				<input type="text" placeholder="Pincode" class="form-control" id="pincode" name="pincode"value="<?php echo set_value('pincode');?>">
																			<?php } else { ?>
																				<input type="text" placeholder="Pincode" class="form-control" id="pincode" name="pincode"value="<?php echo $p['pincode'];?>">
																			<?php } ?>
																...
																<div class="row">
																	...
																	<div class=" col-lg-3 col-md-12">
																		...
																		<label>Latitude</label>
																			...
																			<?php if($this->input->post('submit') && $this->input->post('latitude') !== $p['latitude']) { ?>
																				<input type="text" class="form-control" id="lat" name="latitude" readonly value="<?php echo set_value('latitude');?>">
																			<?php } else { ?>
																				<input type="text" class="form-control" id="lat" name="latitude" readonly value="<?php echo $p['latitude'];?>">
																			<?php } ?>																					
																	...
																	<div class="col-lg-3 col-md-12">
																		...
																		<label>Longitude</label>
																			...
																			<?php if($this->input->post('submit') && $this->input->post('longitude') !== $p['longitude']) { ?>
																				<input type="text" class="form-control" id="long" name="longitude" readonly value="<?php echo set_value('longitude');?>">
																			<?php } else { ?>
																				<input type="text" class="form-control" id="long" name="longitude" readonly value="<?php echo $p['longitude'];?>">
																			<?php } ?>
																...
																<div class="row">
																	...
																	<div class="col-lg-3 col-md-12">
																		...
																		<label>Property Contract</label>
																				...
																				<input type="text" name="property_contract" value="<?php echo $p['property_contract'];?>" readonly class="form-control">
																	...
																	<div class="col-lg-3 col-md-12">
																		...
																		<label>Unit</label>	
																				...
																				<input type="text" class="form-control" id="unit" name="unit" readonly value="<?php echo $p['unit'];?>">
																	...
																	<div class="col-lg-2 col-md-12">
																		...
																		<label>Property Unit</label>
																			...
																			<?php if($this->input->post('submit') && $this->input->post('property_unit') !== $p['property_unit']) { ?>
																				<input type="text" class="form-control" id="property_unit" name="property_unit" placeholder="Property Unit" value="<?php echo set_value('property_unit');?>" readonly>
																			<?php } else { ?>
																				<input type="text" class="form-control" id="property_unit" name="property_unit" placeholder="Property Unit" value="<?php echo $p['property_unit'];?>" readonly>
																			<?php } ?>
																	...
																	<div class="col-lg-2 col-md-12">
																		...
																		<label>Property Price Per Unit</label>
																			...
																			<?php if($this->input->post('submit') && $this->input->post('property_price_per_unit') !== $p['property_price_per_unit']) { ?>
																				<input type="text" class="form-control" id="property_price_per_unit" name="property_price_per_unit" placeholder="Enter Price Per Unit" value="<?php echo set_value('property_price_per_unit');?>" readonly>
																			<?php } else { ?>
																				<input type="text" class="form-control" id="property_price_per_unit" name="property_price_per_unit" placeholder="Enter Price Per Unit" value="<?php echo $p['property_price_per_unit'];?>" readonly>
																			<?php } ?>
																	...
																	<div class="col-lg-2 col-md-12">
																		...
																		<label>Total Price</label>
																			...
																			<?php if($this->input->post('submit') && $this->input->post('property_total_price') !== $p['total_price']) { ?>
																			...
																			<?php } else { ?>
																				<input type="text" class="form-control" id="property_total_price" name="property_total_price" placeholder="Enter Total Price" value="<?php echo $p['total_price'];?>" readonly>
																			<?php } ?>
															...
															<?php if($p['property_type'] === 'Building/Warehouse/Commercial Building') {?>
															<div class="form-group" id="building">
																...
																<div class="row">
																	...
																	<div class="col-lg-6 col-md-12">
																		...
																		<input type="text" class="form-control" id="rera_number" name="rera_number" placeholder="Enter RERA Number" value="<?php echo $p['rera_number'];?>">
																	...
																	<div class="col-lg-6 col-md-12">
																		...
																		<input type="text" class="form-control" id="bu_number" name="bu_number" placeholder="Enter BU Number" value="<?php echo $p['bu_number'];?>">
														...
														<?php if($p['property_type'] === 'N/A Land' OR $p['property_type'] === 'Agricultural Land'){?>
																	...
																	<div class="col-lg-6 col-md-12">
																		...
																		<label>Nature of Land</label>
																		 ...
																		 <select class="form-control" id="nature_of_land" name="nature_of_land">
									                                        ...
									                                        <option value="Industrial" <?php if($p['nature_of_land'] == "Industrial"){ echo 'Selected';}?>>Industrial</option>

									                                        <option value="Commercial" <?php if($p['nature_of_land'] == "Commercial"){ echo 'Selected';}?>>Commercial</option>

									                                        <option value="Residential"  <?php if($p['nature_of_land'] == "Residential"){ echo 'Selected';}?>>Residential</option>
																		...
																		<select class="form-control" id="type_of_land" name="type_of_land">
									                                        	...
									                                        	<option value="">Choose Land Type</option>
																					<?php foreach($land_type as $land):?>
																						<option value="<?php echo $land['land_type_id'];?>" <?php if($p['land_type_id']== $land['land_type_id']){echo 'Selected';}?>><?php echo $land['land_type'];?></option>
	    																			<?php endforeach; ?>
														...
														<div class="form-group" id="building" style="display: none;">
																...
																<div class="row">
																	...
																	<div class="col-lg-6 col-md-12">
																		...
																		<input type="text" class="form-control" id="rera_number" placeholder="Enter RERA Number" value="<?php echo set_value('rera_number');?>">
																		<font color="red"><?=form_error("rera_number");?></font>
																	...
																	<div class="col-lg-6 col-md-12">
																		...
																		<input type="text" class="form-control" id="bu_number" placeholder="Enter BU Number" value="<?php echo set_value('bu_number');?>">
																		<font color="red"><?=form_error("bu_number");?></font>
																...
																<div class="row">
																	...
																	<div class="col-lg-6 col-md-12">
																		...
																		<label>Nature of Land</label>
																		 ...
																		 <select class="form-control" id="nature_of_land">
																	...
																	<div class="col-lg-6 col-md-12">
																		...
																		<select class="form-control" id="type_of_land">
																...
																<div class="row">
																	...
																	<div class="col-lg-4 col-md-12">
																		...
																		<label>Property Controller</label>
																			...
																			<?php if($this->input->post('submit') && $this->input->post('property_controller') !== $p['property_controller_id']) { ?>
																			...
																			<?php } else { ?>
																				<select class="form-control" name="property_controller">
																					...
																					<option value="">Choose Property Controller</option>
																							<?php foreach($property_controller as $controller):?>
																								<option value="<?php echo $controller['user_id'];?>" <?php if($p['property_controller_id']== $controller['user_id']){echo 'Selected';}?>><?php echo $controller['username'];?></option>
			    																			<?php endforeach; ?>
																	...
																	<div class="col-lg-4 col-md-12">
																		...
																		<label>Property Jurisdiction</label>
																			...
																			<?php if($this->input->post('submit') && $this->input->post('property_jurisdiction') !== $p['property_juridiction_id']) { ?>
																			...
																			<?php } else { ?>
																				<select class="form-control" id="property_jurisdiction" name="property_jurisdiction">
																					...
																					<option value="">Choose Property Jurisdiction</option>
																							<?php foreach($jurisdiction as $juri):?>
																								<option value="<?php echo $juri['jurisdiction_id'];?>" <?php if($p['property_juridiction_id']== $juri['jurisdiction_id']){echo 'Selected';}?>><?php echo $juri['property_jurisdiction'];?></option>
			    																			<?php endforeach; ?>
																	...
																	<div class="col-lg-4 col-md-12">
																		...
																		<label>Property Group</label>
																			...
																			<?php if($this->input->post('submit') && $this->input->post('property_group') !== $p['property_group_id']) { ?>
																			...
																			<?php } else { ?>
																				<select class="form-control" id="property_group" name="property_group">

																					<option value="">Choose Property Group</option>
																							<?php foreach($property_group as $group):?>
																								<option value="<?php echo $group['property_group_id'];?>" <?php if($p['property_group_id']== $group['property_group_id']){echo 'Selected';}?>><?php echo $group['property_group'];?></option>
			    																			<?php endforeach; ?>
																...
																<div class="row">
																	...
																	<div class="col-lg-6 col-md-12">
																		...
																		<div class="wd-200 mg-b-30">
																			...
																			<div class="input-group">
																				...
																				<?php if($this->input->post('submit') && $this->input->post('purchase_date') !== $p['property_purchase_date']) { ?>
																					<input class="form-control" id="datepicker0" autocomplete="off" placeholder="Purchase Date" name="purchase_date" type="text" value="<?php echo set_value('purchase_date');?>">
																				<?php } else { ?>
																					<input class="form-control" id="datepicker0" autocomplete="off" placeholder="Property Purchase Date" name="purchase_date" type="text" value="<?php echo date("d-m-Y", strtotime($p['property_purchase_date']))?>">
																				<?php } ?>																				
																			</div>
																	...
																	<div class="col-lg-6 col-md-12">
																		...
																		<label>Property Satus</label>
																			...
																			<?php if($this->input->post('submit') && $this->input->post('status') !== $p['property_status_id']) { ?>
																			...
																			<?php } else { ?>
																				<select class="form-control" id="status" name="status">
																					...
																					<option value="">Choose Property Status</option>
																							<?php foreach($property_status as $pstatus):?>
																								<option value="<?php echo $pstatus['property_status_id'];?>" <?php if($p['property_status_id']== $pstatus['property_status_id']){ echo 'Selected';}?>><?php echo $pstatus['property_status'];?></option>
			    																			<?php endforeach; ?>
																...
																<div class="row">
																	...
																	<div class="col-lg-12 col-md-12">
																		...
																		<label>Property Remark</label>
																			...
																			<?php if($this->input->post('submit') && $this->input->post('property_remark') !== $p['property_remarks']) { ?>
																					<textarea id="elm1" name="property_remark"><?php echo set_value('property_remark');?>
																					</textarea>	
																			<?php } else { ?>
																				<textarea id="elm1" name="property_remark"><?php echo $p['property_remarks'];?></textarea>	
																			<?php } ?>
															...
															if($new_in==2) { echo "Supported Image Type is JPEG/JPG/PNG."; } ?></font>
															...
															<div class="form-group">
																...
																<div class="row">
																	...
																	<div class="col-lg-12 col-md-12">
																		...
																		<input type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModa<?php echo $count; ?>"  value="View Property Images" style="float:right;">
																	<?php } ?>
										...
										<table id="example1" class="table table-striped table-bordered text-wrap w-100">
											...
											<thead>
												...
												<tr>
													...
													<th class="wd-15p">Property Image</th>
																		 ...
																		 <?php  if(!empty($property_images))
                              {
                              	$count = 1;
                              	 ...
                              	 foreach ($property_images as $images){  $image =  base64_decode($images['property_image']);
                              	 	//$encode = $this->encrypt->encode($user["user_id"]);
                              	 	...
                              	 	?>
												...
												<tr>
													...
													<td><a href="<?php echo base_url('Property/download_property_images/'.base64_encode($images['property_image_id']));?>">
																		
																		<embed src="<?php echo base_url('assets/images/uploads/property/'.$image);?>" style="height:80px;widht:150px;"> </embed> </a></td>




													<td><a class="btn btn-danger"  href="<?php echo base_url('Property/delete_edit_property_images/'.base64_encode($images["property_image_id"]));?>" onclick="return confirm('Are You Sure You Want To Delete Property Image?');" style="widht:150px;"><i class="fa fa-trash"></i> Delete</a></td>
												...
												<?php $count++;}}?>
																		...
																		<br/>
																			<?php foreach($property_images as $images){ $image =  base64_decode($images['property_image']);
																		?>




																		<a href="<?php echo base_url('Property/download_property_images/'.base64_encode($images['property_image_id']));?>">
																		
																		<embed src="<?php echo base_url('assets/images/uploads/property/'.$image);?>" style="height:80px;widht:150px;"> </embed> </a>
												...
												<div class="list-group-item py-3" data-acc-step>
													...
													<h5 class="mb-0" data-acc-title onClick="showBorkerDetails()">Broker Details</h5>



													<div data-acc-content id="borker_details">
															...
															<div class="form-group">
																...
																<div class="row">
																	...
																	<div class="col-lg-3 col-md-12">
																		...
																		<?php if($this->input->post('submit') && $this->input->post('broker_name') !== $brok['broker_name']) { ?>
																		...
																		<?php } else { ?>
																			<select name="broker_name" id="broker_name" class="form-control">
																				...
																				<?php foreach($broker as $b):?>
																							...
																							<option value="<?php echo $b['user_id'];?>" <?php if ($brok['broker_name']== $b['user_id']){ echo 'Selected';}?>><?php echo $b['username'];?></option>
		    																			<?php endforeach; ?>
																	...
																	<div class="col-lg-3 col-md-12">
																		...
																		<?php if($this->input->post('submit') && $this->input->post('commission_type') !== $brok['broker_commission_type']) { ?>
																		...
																		<?php } else { ?>
																			<label class="custom-control custom-radio">
																				...
																				<input type="radio" class="custom-control-input" name="commission_type" value="Percentage" <?php if($brok['broker_commission_type']== "Percentage") { echo 'Checked';}?>>



																				<span class="custom-control-label" style="color:black;" value="<?php echo $brok['broker_commission_type'];?>">Percentage</span>
																			...
																			<label class="custom-control custom-radio">
																				...
																				<input type="radio" class="custom-control-input" name="commission_type" value="Fixed Amount" <?php if($brok['broker_commission_type']== "Fixed Amount") { echo 'Checked';}?>>



																				<span class="custom-control-label" style="color:black;" value="<?php echo $brok['broker_commission_type'];?>">Fixed Amount</span>
																	...
																	<div class="col-lg-3 col-md-12">
																		...
																		<?php if($this->input->post('submit') && $this->input->post('brokerage_amount') !== $brok['brokerage_amount']) { ?>
																		...
																		<?php } else { ?>
																			<input type="text" name="brokerage_amount" id="brokerage_amount" name="brokerage_amount" class="form-control" value="<?php echo $brok['brokerage_amount'];?>" placeholder="Enter Brokerage Amount">
																		<?php } ?>
																	...
																	<div class="col-lg-3 col-md-12">
																		...
																		<?php if($this->input->post('submit') && $this->input->post('brokerage_amount_paid') !== $brok['brokerage_amount_to_paid']) { ?>
																		...
																		<?php } else { ?>
																			<input type="text" name="brokerage_amount_paid" id="brokerage_amount_paid" name="brokerage_amount_paid" class="form-control" readonly value="<?php echo $brok['brokerage_amount_to_paid'];?>" placeholder="Brokerage Amount To Be Paid">
																		<?php } ?>
															...
															<div class="form-group">
																...
																<div class="row">
																	...
																	<div class="col-lg-6 col-md-12">
																		...
																		<?php if($this->input->post('submit') && $this->input->post('payment_status') !== $brok['payment_status']) { ?>
																		...
																		<?php } else { ?>
																			<select class="form-control" id="payment_status" name="payment_status" onchange='checkpayment(this.value);'>
																				...
																				<option value="Paid" <?php if($brok['payment_status']== "Paid"){ echo 'Selected';}?>>Paid</option>

																				<option value="Partically Paid" <?php if($brok['payment_status']== "Partically Paid"){ echo 'Selected';}?>>Partically Paid</option>

																				<option value="Not Paid" <?php if($brok['payment_status']== "Not Paid"){ echo 'Selected';}?>>Not Paid</option>
																	...
																	<div class="col-lg-6 col-md-12">
																		...
																		<div class="wd-200 mg-b-30">
																			...
																			<div class="input-group">
																				...
																				<?php if($this->input->post('submit') && $this->input->post('payment_date') !== $brok['payment_date']) { ?>

																					<input class="form-control" id="datepicker1" placeholder="Payment Date" type="text" name="payment_date" value="<?php echo set_value('payment_date');?>">

																				<?php } else { ?>

																					<input class="form-control" id="datepicker1" placeholder="Payment Date" type="text" name="payment_date" value="<?php echo date("d-m-Y", strtotime($brok['payment_date']));?>">
																...
																<div class="form-group">
																	...
																	<div class="row">
																		...
																		<div class="col-lg-6 col-md-12">
																			...
																			<?php if($this->input->post('submit') && $this->input->post('partical_amount') !== $brok['partically_paid_amount']) { ?>
																			...
																			<?php } else { ?>
																				...
																				<input type="text" class="form-control" id="partical_amount"  placeholder="Enter Partically Paid Amount" value="<?php echo $brok['partically_paid_amount'];?>">
												...
												<div id="leasse_seller">
														...
														<?php if($p['property_contract'] == 'Lease') {?>
															<div id="leasse">



																	<h5 class="mb-0" data-acc-title onClick="showLeasseDetails()">Lessee Details</h5>



																	<div data-acc-content id="show_leasse_details">
																				...
																				<div class="form-group removethis4">
																					...
																					<div class="row">
																						...
																						<div class="col-lg-6 col-md-12">
																							...
																							<select id="leasse_name[<?= $one ?>]" name="leasse_name[<?= $one ?>]" class="form-control">

																								<option value="">Choose Lessee Name</option>

																							 <?php foreach($lesse as $b):?>
																						<option value="<?php echo $b['user_id'];?>" <?php if ($les['lessee_name']== $b['user_id']){echo 'Selected';}?>><?php echo $b['username'];?></option>
	    																			<?php endforeach; ?>
																						...
																						<div class="col-lg-6 col-md-12">
																							...
																							<input type="text" class="form-control" id="leasse_share_in_property[<?= $one ?>]"  name="leasse_share_in_property[<?= $one ?>]" value="<?php echo $les['share_in_property'];?>" placeholder="Share in Property">
																		...
																		<div class="col-lg-4 col-md-4">
													                                        ...
													                                        <input type="button" class="btn btn-primary" id="removeleasse" value="Remove"></button>
														...
														<?php } ?>	
															...
															<!--seller-->
															<?php if($p['property_contract'] == 'Buy') {?>

															<div id="seller">

																

																<h5 class="mb-0" data-acc-title onClick="showSellerDetails()">Seller Details</h5>



																<div data-acc-content id="show_seller_details">
																	...
																	<div class="my-3">
																		...
																		<?php $one = 0; foreach($seller1 as $sel){?>
																		
																			<div class="col-md-12 col-lg-12">

																			<div class="form-group removethis">
																				...
																				<div class="row">
																					...
																					<div class="col-lg-6 col-md-12">
																						...
																						<label>Seller Name</label>
																							...
																							<select id="seller_name[<?= $one ?>]" name="seller_name[<?= $one ?>]" class="form-control">

																							<option value="">Choose Seller</option>

																							  <?php foreach($seller as $b):?>
																						<option value="<?php echo $b['user_id'];?>" <?php if ($sel['seller_name']== $b['user_id']) { echo 'Selected';}?>><?php echo $b['username'];?></option>
	    																			<?php endforeach; ?>
																							</select>
																					...
																					<div class="col-lg-6 col-md-12">
																						...
																						<input type="text" class="form-control" id="share_in_property[<?= $one ?>]"  name="share_in_property[<?= $one ?>]" value="<?php echo $sel['share_in_property'];?>" placeholder="Share in Property">
															...
															<div id="leasse" style="display: none;">



																	<h5 class="mb-0" data-acc-title onClick="showLeasseDetails()">Leasse Details</h5>
																				...
																				<div class="form-group">
																					...
																					<div class="row">
																						...
																						<div class="col-lg-4 col-md-12">
																							...
																							<select id="leasse_name" class="form-control">
	    																			...
	    																			<?php endforeach; ?>
																						...
																						<div class="col-lg-4 col-md-12">
																							...
																							<input type="text" class="form-control" id="leasse_share_in_property" value="<?php echo set_value('leasse_share_in_property[0]');?>" placeholder="Share in Property">
																				...
																				<div class="row">
																					...
																					<div class="col-lg-4 col-md-12">
																						...
																						<label>Seller Name</label>
																							...
																							<select id="seller_name" class="form-control">
																					...
																					<div class="col-lg-4 col-md-12">
																						...
																						<input type="text" class="form-control" id="share_in_property" placeholder="Share in Property" value="<?php echo set_value('share_in_property[0]');?>">
												...
												<div id="leassor_purchaser">
													...
													<div class="list-group-item py-3" data-acc-step>
														...
														<div id="leassor">
															...
															<h5 class="mb-0" data-acc-title onClick="showLessorDetails()">Leassor Details</h5>



															<div data-acc-content id="show_lessor_details">
																...
																<div class="my-3">
																	...
																	<?php $one = 0;  foreach($lessor1 as $leo){?>
																	<div class="col-md-12 col-lg-12">
																			...
																			<div class="row">
																				...
																				<div class="col-lg-6 col-md-12">
																					...
																					<label>Lessor Name</label>
																							...
																							<select id="leassor_name[<?= $one ?>]" name="leassor_name[<?= $one ?>]" class="form-control">

																								<option value="">Choose Lessor</option>

																							  <?php foreach($lessor as $b):?>
																						<option value="<?php echo $b['user_id'];?>" <?php if ($leo['lessor_name']== $b['user_id']) { echo 'Selected';}?>><?php echo $b['username'];?></option>
	    																			<?php endforeach; ?>
																				...
																				<div class="col-lg-6 col-md-12">
																					...
																					<input type="text" class="form-control" id="leassor_share_in_property[<?= $one ?>]"  name="leassor_share_in_property[<?= $one ?>]" value="<?php echo $leo['share_in_property'];?>" placeholder="Share in Property">
																		...
																		<div class="form-group">
																			<div class="row">
																				<div class="col-lg-4 col-md-4">
											                                        ...
											                                        <input type="button" class="btn btn-primary" id="leassorremove" value="Remove"></button>
													...
													<?php }?>
														...
														<?php if($p['property_contract'] == 'Buy') { ?>
														<div id="purchaser_div">



															<h5 class="mb-0" data-acc-title onClick="showPurchaserDetails()">Purchaser Details</h5>



															<div data-acc-content id="show_purchaser_details">
																...
																<div class="my-3">
																	...
																	<?php $one = 0; foreach($purchaser1 as $pur){?>

																		<div class="col-md-12 col-lg-12">

																			<div class="form-group removethis2">
																		...
																		<div class="row">
																				...
																				<div class="col-lg-6 col-md-12">
																					...
																					<label>Purchaser Name</label>
																							...
																							<select id="purchaser_name[<?= $one ?>]" name="purchaser_name[<?= $one ?>]" class="form-control">

																							<option value="">Choose Purchaser</option>	

																							  <?php foreach($purchaser as $b):?>
																						<option value="<?php echo $b['user_id'];?>" <?php if ($pur['purchaser_name']== $b['user_id']) { echo 'Selected';}?>><?php echo $b['username'];?></option>
	    																			<?php endforeach; ?>
																				...
																				<div class="col-lg-6 col-md-12">
																					...
																					<input type="text" class="form-control" id="purchaser_share_in_property[<?= $one ?>]"  name="purchaser_share_in_property[<?= $one ?>]" value="<?php echo $pur['share_in_property'];?>" placeholder="Share in Property">
																		...
																		<div class="col-lg-4 col-md-4">
											                                        ...
											                                        <input type="button" class="btn btn-primary" id="purchaser_remove" value="Remove"></button>
													...
													<?php } ?>
														...
														<div id="leassor" style="display: none;">
																			...
																			<div class="row">
																				...
																				<div class="col-lg-4 col-md-12">
																					...
																					<label>Lessor Name</label>
																							...
																							<select id="leassor_name" class="form-control">
																				...
																				<div class="col-lg-4 col-md-12">
																					...
																					<input type="text" class="form-control" id="leassor_share_in_property"   value="<?php echo set_value('leassor_share_in_property[0]');?>" placeholder="Share in Property">
																		...
																		<div class="row">
																				...
																				<div class="col-lg-4 col-md-12">
																					...
																					<label>Purchaser Name</label>
																							...
																							<select id="purchaser_name" class="form-control">
																				...
																				<div class="col-lg-4 col-md-12">
																					...
																					<input type="text" class="form-control" id="purchaser_share_in_property" placeholder="Share in Property" value="<?php echo set_value('purchaser_share_in_property[0]');?>">
												...
												<div class="list-group-item py-3" data-acc-step>
													...
													<h5 class="mb-0" data-acc-title onClick="showPropertyFixedExpenseDetails()">Property Fixed Expenses</h5>

													<div data-acc-content id="show_property_fixed_expense_details">

														<div class="my-3">
															<div class="row">

															<?php $one= 0; foreach($fixed_expense1 as $expense1){?>

															<div class="col-md-12 col-lg-12">

															  <div class="form-group removethis1">
																...
																<div class="row">
																	...
																	<div class="col-lg-6 col-md-12">
																		...
																		<select class="form-control" id="add_expense[<?= $one ?>]" name="add_expense[<?= $one ?>]" onchange='show_expense(this.value);'>

																			<option value="">Choose Fixed Expense</option>
																					<?php foreach($fixed_expense as $expense):?>
																						<option value="<?php echo $expense['fixed_expense_id'];?>" <?php if($expense1['expense_type_id']== $expense['fixed_expense_id']){ echo 'Selected';}?>><?php echo $expense['fixed_expense'];?></option>
	    																			<?php endforeach; ?>
																	...
																	<div class="col-lg-6 col-md-12">
																		...
																		<input type="text" class="form-control" id="expense_amount[<?= $one ?>]" name="expense_amount[<?= $one ?>]" placeholder="Enter Expense Amount" value="<?php echo $expense1['expense_amount'];?>">
														...
														<div class="form-group">
											                            ...
											                            <input type="button" class="btn btn-primary" id="expense_remove" value="Remove"></button>
...
var setlat = '<?php echo set_value("latitude");?>';
	...
	var elat = <?php echo $p['latitude'];?>;
	var elng = <?php echo $p['longitude'];?>;
		...
		{
			var myLatLng = {lat: elat, lng: elng};
		}
		else
		{
  ...
  [...files].forEach( readImage );
		...
		<script>
			$(document).ready(function(){ 
				...
				var val = property_type.options[property_type.selectedIndex].text;
				   
				    var element=document.getElementById('building');
				    if(val=='Building/Warehouse/Commercial Building'){
					 
					   var myElement = $('select[name="nature_of_land"]');
					
					   myElement.val(myElement.find('option').first().val());
					   var myElement = $('select[name="type_of_land"]');
					
					   myElement.val(myElement.find('option').first().val());
						element.style.display='block'; 
						$('#rera_number').attr('name','rera_number');
						$('#bu_number').attr('name','bu_number');
					...
					myElement.val(myElement.find('option').first().val());
 					...
 					var myElement = $('input[name="bu_number"]');
					
					myElement.val('');
					var myElement = $('input[name="rera_number"]');
					...
					myElement.val('');
					 ...
					 var element1=document.getElementById('land');
					  if(val=='Agricultural Land' || val=='N/A Land'){
					   ...
					   $('#nature_of_land').attr('name','nature_of_land');
						$('#type_of_land').attr('name','type_of_land');
		...
		<script>
			...
			function checkpayment(val){
				 ...
				 var element=document.getElementById('partically_paid_amount');
				  $('#partical_amount').attr('name','partical_amount');
				 ...
				 if(val=='Partically Paid')
				   ...
				   element.style.display='block';
				 	...
				 	var myElement = $('input[name="partical_amount"]');
				...
				function checkcontract(val){
				 ...
				 if(val=='Buy'){
				   ...
				   element.style.display='block';
				    ...
				    $('#seller_name').attr('name','seller_name[0]');

					$('#share_in_property').attr('name','share_in_property[0]');	



				   $('#purchaser_name').attr('name','purchaser_name[0]');

					$('#purchaser_share_in_property').attr('name','purchaser_share_in_property[0]');						
				...
				if(val=='Lease'){
				   ...
				   element2.style.display='block';
				    ...
				    element3.style.display='block';
				     ...
				     $('#leassor_name').attr('name','leassor_name[0]');

					$('#leassor_share_in_property').attr('name','leassor_share_in_property[0]');

					 $('#leasse_name').attr('name','leasse_name[0]');

				   $('#leasse_share_in_property').attr('name','leasse_share_in_property[0]');
    ...
    var x = <?php if(!empty($seller1)) { echo count($seller1); } else { echo 1; } ?>;
        ...
        $(document).ready(function() {
            ...
            $("#adddoc1").on("click", function() {
             ...
             $("#removedoc1").on("click", function() {
				 ...
				 var acount = <?php echo count($seller1); ?>
             	...
             	{
             		 $(".removethis").children().last().remove();
             	}
             	x--;
	...
	var x1 = <?php if(!empty($purchaser1)) { echo count($purchaser1); } else { echo 1; } ?>;
        ...
        $(document).ready(function() { 
            ...
            $("#purchaser_add").on("click", function() {
             ...
             $("#purchaser_remove").on("click", function() {
             	...
             	var acount = <?php echo count($purchaser1); ?>
             	...
             	{
             		 $(".removethis2").children().last().remove();
             	}
             	x1--;
	...
	var x2 = <?php if(!empty($lessee1)) { echo count($lessee1); } else { echo 1; } ?>;
	...
	var x3 = <?php if(!empty($lessor1)) { echo count($lessor1); } else { echo 1; } ?>;
        ...
        $(document).ready(function() {
            $("#leassoradd").on("click", function() {
             ...
             $("#leassorremove").on("click", function() {
             	...
             	var acount = <?php echo count($lessor1); ?>
    ...
    var x4 = <?php echo count($fixed_expense1); ?>;
        ...
        $(document).ready(function() {
            ...
            $("#expense_add").on("click", function() {
             ...
             $("#expense_remove").on("click", function() {
             	...
             	var acount = <?php echo count($fixed_expense1); ?>
             	...
             	{
             		 $(".removethis1").children().last().remove();
             	}
             	x4--;
    ...
    <script>
    	...
    	$('#property_price_per_unit').keyup(function(){
    	...
    	$('#brokerage_amount').change(function(){
            if($("input[type=radio][name=commission_type]").is(":checked")) {
            	...
            	var element1=$('input[name="commission_type"]:checked').val();
 			 	  ...
 			 	  if (element1 == 'Fixed Amount') {
 			 	  	var brokerage_amount = document.getElementById('brokerage_amount').value;
 			 	  	 $("#brokerage_amount_paid").val(brokerage_amount);
 			 	  }
 			 	  else{
 			 	  	...
 			 	  	var amount_to_paid = (total_price * brokerage_amount) / 100;
 			 	  	 $("#brokerage_amount_paid").val(amount_to_paid);
    	    	...
    	    	function showBorkerDetails(){
    		 if(!$('#borker_details').is(':visible'))
				{
					$("#borker_details").css("display", "block");
				} else {
					$("#borker_details").css("display", "none");
				}
    	}

    	function showLeasseDetails(){
    		 if(!$('#show_leasse_details').is(':visible'))
				{
					$("#show_leasse_details").css("display", "block");
				} else {
					$("#show_leasse_details").css("display", "none");
				}
    	}

    	function showSellerDetails(){
    		 if(!$('#show_seller_details').is(':visible'))
				{
					$("#show_seller_details").css("display", "block");
				} else {
					$("#show_seller_details").css("display", "none");
				}
    	}

    	function showLessorDetails(){
    		 if(!$('#show_lessor_details').is(':visible'))
				{
					$("#show_lessor_details").css("display", "block");
				} else {
					$("#show_lessor_details").css("display", "none");
				}
    	}

    	function showPurchaserDetails(){
    		 if(!$('#show_purchaser_details').is(':visible'))
				{
					$("#show_purchaser_details").css("display", "block");
				} else {
					$("#show_purchaser_details").css("display", "none");
				}
    	}

    	function showPropertyFixedExpenseDetails(){
    		 if(!$('#show_property_fixed_expense_details').is(':visible'))
				{
					$("#show_property_fixed_expense_details").css("display", "block");
				} else {
					$("#show_property_fixed_expense_details").css("display", "none");
				}
    	}
