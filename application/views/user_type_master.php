				...
				<div class="app-content  my-3 my-md-5">
					...
					<div class="side-app">
						...
						<div class="page-header">
							...
							<div class="ml-auto">
								<div class="input-group">
									...
									<?php } ?>
									<?php if(in_array("Users Master",$r)) { ?>
    						...
    						<?php endif;?> 
								...
								<div class="card">
									...
									<div class="card-header pb-0">
										...
										<h3 class="card-title">Add User Type Details</h3>

									</div>

									<div class="card-body">

										 <?php echo form_open_multipart('Users/user_type_insert',array("method"=>"POST")); ?>
						...
						<div class="row">
    						...
    						<?php if($this->session->flashdata('user_type_update')) :?>

								<div class="alert alert-success alert-dismissable">
                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <?php echo $this->session->flashdata('user_type_update'); ?>
                                </div>
							...
							<div class="card">
								...
								<div class="card-header pb-0">
									...
									<div class="card-title">User Type List</div>
								...
								<div class="card-body">
                                	...
                                	<div class="table-responsive">
										...
										<table class="table table-striped table-bordered text-nowrap w-100"  id="example1">
                              	...
                              	$count = 1;
                              	 ...
                              	 foreach ($users as $user){?>
												...
												<tr>
													...
													<!--<td><a class="btn btn-danger" href="<?php echo base_url('Users/delete_user/'.base64_encode($user['user_type_id']));?>" onclick="return confirm('Are You Sure You Want To Delete User Type');"><i class="fa fa-trash"></i> Delete</a></td>-->

													<td><a class="btn btn-primary" href="<?php echo base_url('Users/update_user_type/'.base64_encode($user['user_type_id']));?>"><i class="fa fa-edit"></i>Edit</a></td>
