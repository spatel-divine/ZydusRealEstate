					...
					<div class="side-app">
						...
						<div class="page-header">
							...
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item active" aria-current="page">View Recurring Income Details</li>
						...
						<div class="row">
							...
							<div class="card">
								...
								<div class="card-header pb-0">
									...
									<div class="card-title">Recurring Income Lists</div>
								...
								<div class="card-body">
								<?php echo form_open('Income/filter_recurring_income/',array("method"=>"POST","id"=>"form-filter")); ?>	
									...
									<div class="form-group">
										...
										<div class="row">
											...
											<div class="col-lg-2 col-md-12">
													...
													<a class="btn btn-primary" href="<?php echo base_url('Income/recurring_income_list/');?>" style="margin-top:24px;width:80px;">Reset</a>
												</div>
										...
										<table id="example" class="table table-striped table-bordered text-wrap w-100">
											...
											<thead>
												...
												<tr>
													...
													<?php if(in_array("View Income List",$r)) { ?>
											...
											<tbody>
												...
												<tr>
													...
													<td><?= date("d-m-Y", strtotime($income['next_recurring_date']))?></td>
