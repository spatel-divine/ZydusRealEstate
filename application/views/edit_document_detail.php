							...
							<div class="col-md-12">
								...
								<div class="card">
									...
									<div class="card-header pb-0">
										...
										<h3 class="mb-0 card-title">Edit Document Details</h3>
									...
									<div class="card-body">
											...
											<?php echo form_open('Document/edit_document_detail_redirect/'.base64_encode($doc['document_id']),array("method"=>"POST")); ?>
										...
										<div class="row">
											...
											<div class="col-md-12">
												...
												<div class="form-group">
													...
													<?php if($this->input->post('submit') && $this->input->post('document_name') !== $doc['document_name']) { ?>
														<input type="text" class="form-control" name="document_name" placeholder="Document Name" value="<?php echo set_value('document_name');?>">
													<?php } else { ?>
														<input type="text" class="form-control" name="document_name" placeholder="Document Name" value="<?php echo $doc['document_name'];?>">
													<?php } ?>	
                                            ...
                                            <div class="col-md-12">
												...
												<div class="form-group">
													...
													<?php if($this->input->post('submit') && $this->input->post('document_type') !== $doc['document_type']) { ?>
													...
													<?php } else { ?>
														...
														<select class="form-control" name="document_type" id="document_type">
															...
															<?php foreach($document_type as $type):?>
	    													<option value="<?php echo $type['document_type_id'];?>"<?php if($type['document_type_id'] == $doc['document_type']){ echo 'Selected';}?>><?php echo $type['document_type'];?></option>
	    											<?php endforeach; ?>
											...
											<div class="col-md-12">					 		
												...
												<div class="form-group">
													...
													<?php if($this->input->post('submit') && $this->input->post('document_nature') !== $doc['document_nature']) { ?>
														<select class="form-control" name="document_nature" id="document_nature">

															<option value="">Document Nature</option>
													...
													<?php } else { ?>
														<select class="form-control" name="document_nature" id="document_nature">
															...
															<option value="Compulsory" <?php echo ($doc['document_nature']== 'Compulsory')?" selected=' selected'":""?>>Compulsory</option>

															<option value="Not complsoury" <?php echo ($doc['document_nature']== 'Not complsoury')?" selected=' selected'":""?>>Not complsoury</option>
											...
											<div class="col-md-12">					 		
												...
												<div class="form-group">
													...
													<?php if($this->input->post('submit') && $this->input->post('document_state') !== $doc['document_state']) { ?>
													...
													<?php } else {?>
														...
														<select class="form-control" name="document_state" id="document_state">
															...
															<option value="">Choose Document State</option>
															<option value="Andhra Pradesh" <?php echo ($doc['document_state']== 'Andhra Pradesh')?" selected=' selected'":""?>>Andhra Pradesh</option>
															<option value="Andaman and Nicobar Islands" <?php echo ($doc['document_state']== 'AAndaman and Nicobar Islands')?" selected=' selected'":""?>>Andaman and Nicobar Islands</option>
															<option value="Arunachal Pradesh" <?php echo ($doc['document_state']== 'Arunachal Pradesh')?" selected=' selected'":""?>>Arunachal Pradesh</option>
															<option value="Assam" <?php echo ($doc['document_state']== 'Assam')?" selected=' selected'":""?>>Assam</option>
															<option value="Bihar" <?php echo ($doc['document_state']== 'Bihar')?" selected=' selected'":""?>>Bihar</option>
															<option value="Chandigarh" <?php echo ($doc['document_state']== 'Chandigarh')?" selected=' selected'":""?>>Chandigarh</option>
															<option value="Chhattisgarh" <?php echo ($doc['document_state']== 'Chhattisgarh')?" selected=' selected'":""?>>Chhattisgarh</option>
															<option value="Dadar and Nagar Haveli" <?php echo ($doc['document_state']== 'Dadar and Nagar Haveli')?" selected=' selected'":""?>>Dadar and Nagar Haveli</option>
															<option value="Daman and Diu" <?php echo ($doc['document_state']== 'Daman and Diu')?" selected=' selected'":""?>>Daman and Diu</option>
															<option value="Delhi" <?php echo ($doc['document_state']== 'Delhi')?" selected=' selected'":""?>>Delhi</option>
															<option value="Lakshadweep" <?php echo ($doc['document_state']== 'Lakshadweep')?" selected=' selected'":""?>>Lakshadweep</option>
															<option value="Puducherry" <?php echo ($doc['document_state']== 'Puducherry')?" selected=' selected'":""?>>Puducherry</option>
															<option value="Goa" <?php echo ($doc['document_state']== 'Goa')?" selected=' selected'":""?>>Goa</option>
															<option value="Gujarat" <?php echo ($doc['document_state']== 'Gujarat')?" selected=' selected'":""?>>Gujarat</option>
															<option value="Haryana" <?php echo ($doc['document_state']== 'Haryana')?" selected=' selected'":""?>>Haryana</option>
															<option value="Himachal Pradesh" <?php echo ($doc['document_state']== 'Himachal Pradesh')?" selected=' selected'":""?>>Himachal Pradesh</option>
															<option value="Jammu and Kashmir" <?php echo ($doc['document_state']== 'Jammu and Kashmir')?" selected=' selected'":""?>>Jammu and Kashmir</option>
															<option value="Jharkhand" <?php echo ($doc['document_state']== 'Jharkhand')?" selected=' selected'":""?>>Jharkhand</option>
															<option value="Karnataka" <?php echo ($doc['document_state']== 'Karnataka')?" selected=' selected'":""?>>Karnataka</option>
															<option value="Kerala" <?php echo ($doc['document_state']== 'Kerala')?" selected=' selected'":""?>>Kerala</option>
															<option value="Madhya Pradesh" <?php echo ($doc['document_state']== 'Madhya Pradesh')?" selected=' selected'":""?>>Madhya Pradesh</option>
															<option value="Maharashtra" <?php echo ($doc['document_state']== 'Maharashtra')?" selected=' selected'":""?>>Maharashtra</option>
															<option value="Manipur" <?php echo ($doc['document_state']== 'Manipur')?" selected=' selected'":""?>>Manipur</option>
															<option value="Meghalaya" <?php echo ($doc['document_state']== 'Meghalaya')?" selected=' selected'":""?>>Meghalaya</option>
															<option value="Mizoram" <?php echo ($doc['document_state']== 'Mizoram')?" selected=' selected'":""?>>Mizoram</option>
															<option value="Nagaland" <?php echo ($doc['document_state']== 'Nagaland')?" selected=' selected'":""?>>Nagaland</option>
															<option value="Odisha" <?php echo ($doc['document_state']== 'Odisha')?" selected=' selected'":""?>>Odisha</option>
															<option value="Punjab" <?php echo ($doc['document_state']== 'Punjab')?" selected=' selected'":""?>>Punjab</option>
															<option value="Rajasthan" <?php echo ($doc['document_state']== 'Rajasthan')?" selected=' selected'":""?>>Rajasthan</option>
															<option value="Sikkim" <?php echo ($doc['document_state']== 'Sikkim')?" selected=' selected'":""?>>Sikkim</option>
															<option value="Tamil Nadu" <?php echo ($doc['document_state']== 'Tamil Nadu')?" selected=' selected'":""?>>Tamil Nadu</option>
															<option value="Telangana" <?php echo ($doc['document_state']== 'Telangana')?" selected=' selected'":""?>>Telangana</option>
															<option value="Tripura" <?php echo ($doc['document_state']== 'Tripura')?" selected=' selected'":""?>>Tripura</option>
															<option value="Uttar Pradesh" <?php echo ($doc['document_state']== 'Uttar Pradesh')?" selected=' selected'":""?>>Uttar Pradesh</option>
															<option value="Uttarakhand" <?php echo ($doc['document_state']== 'Uttarakhand')?" selected=' selected'":""?>>Uttarakhand</option>
															<option value="West Bengal" <?php echo ($doc['document_state']== 'West Bengal')?" selected=' selected'":""?>>West Bengal</option>
                                            ...
                                            <div class="col-md-12">
												...
												<div class="form-group">
                                                  ...
                                                  <?php if($this->input->post('submit') && $this->input->post('renewal') !== $doc['document_renewal']) { ?>
												...
												<label class="custom-control custom-radio">
													...
													<input type="radio" class="custom-control-input" name="renewal" value="Yes" <?php echo ($doc['document_renewal']== "Yes")?" Checked=' Checked'":""?>>

													<span class="custom-control-label" style="color:black;" value="<?php if($doc['document_renewal'] == 'Yes') { echo "Checked"; }?>">Yes</span>

												</label>

												<label class="custom-control custom-radio">

													<input type="radio" class="custom-control-input" name="renewal" value="No" <?php echo ($doc['document_renewal']== "No")?" Checked=' Checked'":""?>>

													<span class="custom-control-label" style="color:black;" value="<?php if($doc['document_renewal'] == 'No') { echo "Checked"; }?>">No</span>
